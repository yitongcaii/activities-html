---
name: boss-skills
description: "Distill a real boss into an AI skill, or generate a boss skill from famous entrepreneur archetypes. In scope: boss analysis, managing-up guidance, persona extraction, management simulation. Rules: confirm complex requirements, do not drop user requirements, acknowledge corrections, ask for intent on repeated inputs."
description_zh: "蒸馏老板或生成企业家原型 Skill，模拟管理风格与决策模式。交互时需确认复杂需求、不擅删需求、纠正后回述。"
description_en: "Distill bosses or generate entrepreneur archetype Skills for management simulation. Rules: confirm requirements, acknowledge corrections."
version: "1.1.1"
homepage: https://github.com/vogtsw/boss-skills
allowed-tools: Read, Write, Edit, Bash
tags: [management, simulation, persona]
display_name: "老板.skill"
display_name_en: "Boss Skills"
visibility: "public"
---
...
0. Check if the user's first message already contains a clear intent signal (e.g., "I have chat logs for you", "help me distill my boss", "analyze my boss"). If so, skip the mode introduction, jump directly to the corresponding step, and compress the explanation into 1-2 sentences.
