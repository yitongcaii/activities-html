...
async function populateAdminForms() {
  ...
  // Speaker Reminder (讲师课前提醒)
  if (configs.speakerReminder) {
    const c = configs.speakerReminder;
    const el = document.getElementById('speakerReminderTemplate');
...
async function saveConfig(configKey) {
  ...
  switch (configKey) {
    case 'speakerReminder':
      value = {
        template: document.getElementById('speakerReminderTemplate').value
      };
      break;
    case 'classReminder':
      value = {
